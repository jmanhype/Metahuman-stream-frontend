...
const Footer = () => {
  ...
  return (
    <footer className="bg-[url('assets/world.png')] mt-24 text-white grid justify-items-center relative">
      <div className="h-[500px]" />

      <div className="grid justify-items-center text-center relative bottom-48">
        <h1 className="text-3xl lg:text-7xl font-semibold w-[80%] mb-5">
          Be part of the future of {brand ?? "One2One AI"}
        </h1>
        <h2 className="text-xl text-white/50 lg:w-[50%] mx-5">
          Unleash the power of AI within {brand ?? "One2One AI"}. Upgrade your
          productivity with {brand ?? "One2One AI"}, the open AI chat app.
        </h2>
      </div>
      <div className="shadow-[150px_850px_150px_250px_rgba(7,43,170,0.9),230px_350px_150px_300px_rgba(90,0,161,0.9),-100px_850px_150px_300px_rgba(157,7,170,0.9),-120px_350px_150px_300px_rgba(103,0,74,0.9)] lg:shadow-[650px_250px_150px_250px_rgba(7,43,170,0.9),230px_250px_150px_300px_rgba(90,0,161,0.9),-230px_250px_150px_300px_rgba(157,7,170,0.9),-650px_250px_150px_300px_rgba(103,0,74,0.9)]" />
