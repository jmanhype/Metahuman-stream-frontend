...
const Footer = () => {
  ...
  return (
    <footer className="bg-[url('assets/world.png')] bg-[50%_0%] mt-5 text-white grid justify-items-center relative lg:top-0 top-[-10px] ">
      ...
      <div className="grid justify-items-center text-center relative bottom-48">
        <h1 className="text-3xl lg:text-7xl font-semibold w-[65%] mb-5">
          Embrace cutting-edge AI technology that positions you as an industry
          leader.
        </h1>
